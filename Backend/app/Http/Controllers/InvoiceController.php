...
class InvoiceController extends Controller
{
    ...
    *  @OA\Property(property="company_id", type="string", example="1"),
    ...
    //  * @OA\Get(
    //  *    path="/user/invoice/ubl/{id}",
    //  *  tags={"Invoice"},
    //  * summary="Generate UBL XML",
    //  * description="Generate UBL XML",
    //  * operationId="generateInvoiceUbl",
    //  * @OA\Parameter(
    //  *   name="id",
    //  * in="path",
    //  * description="ID of the invoice",
    ...
    //  * )
    //  */
    // public function generateUblXml($invoiceId)
    // {
    //     $user = auth()->user();
    ...
    //     $company_logo = "https://econiasoft.com/assets/eConiaSoft-Final2222-W1GNMPwf.png";
    ...
    //     $xml->addChild('cbc:ID', $invoice->invoice_id);
    //     $xml->addChild('cbc:UUID', $invoice->invoice_uuid);
    //     $xml->addChild('cbc:IssueDate', $invoice->invoice_date);
    //     $xml->addChild('cbc:CompanyName', $invoice->company->company_name);
    //     $xml->addChild('cbc:InvoiceType', $invoice->type->name);
    //     $xml->addChild('cbc:Scenario', $invoice->scenario->name);
    //     $xml->addChild('cbc:Currency', $invoice->currency->code);
    ...
    //         // Populate invoice line data
    //         $invoiceLine->addChild('cbc:ID', $product->id); // Example, use appropriate ID
    //         $invoiceLine->addChild('cbc:InvoicedQuantity', $product->quantity);

    //         // Add more elements as needed...

    //         // Process decrease/increase for the product
    //         foreach ($product->decreaseIncrease as $decreaseIncrease) {
    //             $decreaseIncreaseElement = $invoiceLine->addChild('cac:DecreaseIncrease');

    //             // Populate decrease/increase data
    //             $decreaseIncreaseElement->addChild('cbc:Amount', $decreaseIncrease->amount);
    //             // Add more elements as needed...
    //         }
    //     }
     ...
     * summary="Generate UBL XML",
     * description="Generate UBL XML",
     * operationId="generateInvoiceUbl2.1",
     * @OA\Parameter(
     *   name="id",
     * in="path",
     * description="ID of the invoice",
